...
var ResultadosIPMaskComponent = (function () {
    function ResultadosIPMaskComponent(dataService, route, translate, sanitizer) {
    ...
    ResultadosIPMaskComponent.prototype.buscarDatosExtraEntity = function (entity) {
        var _this = this;
    ...
    ResultadosIPMaskComponent.prototype.parseGetBuscarEntityOk = function (response) {
    ...
    ResultadosIPMaskComponent.prototype.parseGetBuscarEntityError = function (error) {
    ...
    ResultadosIPMaskComponent.prototype.obtenerDatosEntity = function (respuesta) {
        var handle = "No data";
        var name = "No data";
        var country = "No data";
        var roles = "No data";
    ...
    ResultadosIPMaskComponent.prototype.completarDatosEntities = function (datos) {
        var _this = this;
    ...
    ResultadosIPMaskComponent.prototype.sanitize = function (url) {
